        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ReportAccessLogs_Companies_CompanyId",
                        column: x => x.CompanyId,
                        principalTable: "Companies",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_JournalLine_DebitCredit", "\"Debit\" >= 0 AND \"Credit\" >= 0 AND (\"Debit\" + \"Credit\") > 0");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Accounts_Code_FiscalYear",
                table: "Accounts",
                columns: new[] { "Code", "FiscalYear" },
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ReportAccessLogs_CompanyId",
